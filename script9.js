document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatedImageSources = [
        'images/image9/gen1.png',
        'images/image9/gen2.png',
        'images/image9/gen3.png',
        'images/image9/gen4.png',
        'images/image9/gen5.png',
        'images/image9/gen6.png',
        'images/image9/gen7.png'
    ];
    ...
    function loadImages() {
        ...
        generatedImageSources.forEach((generatedImageSrc, index) => {
            const referenceImageSrc = 'images/image9/ref.png';
    ...
    document.querySelectorAll('[data-next-page], [data-prev-page]').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            if (nextPage) {
                ...
                localStorage.setItem('ranking_page_9', JSON.stringify({
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', function() {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (pageRanking) {
                    allRankings[page_\9] = JSON.parse(pageRanking);
                }
            }
    ...
    const savedRanking = localStorage.getItem('ranking_page_9');
    if (savedRanking) {
