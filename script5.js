document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatedImageSources = [
        ...
        'images/image5/gen2.png',
        'images/image5/gen3.png',
        'images/image5/gen4.png',
        'images/image5/gen5.png',
        'images/image5/gen6.png',
        'images/image5/gen7.png'
    ];
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', function() {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (pageRanking) {
                    allRankings[page_\5] = JSON.parse(pageRanking);
                }
            }
    ...
    const savedRanking = localStorage.getItem('ranking_page_5');
    if (savedRanking) {
