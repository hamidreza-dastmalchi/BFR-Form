...
<body>
    <div class="container">
        ...
        <div class="reference-image">
            ...
            <img id="reference" src="images/image$pageNumber/ref.png" alt="" aria-hidden="true" role="presentation" onerror="this.onerror=null; console.error('Failed to load reference image');">
        </div>
        ...
        <div class="button-container">
            ...
            <div class="navigation-buttons">
                <button class="nav-button" data-prev-page="$prevLink">Previous</button>
                <button id="nextBtn" class="nav-button" data-next-page="$nextLink" disabled>Next</button>
            </div>
        </div>
    </div>
...
"@
    ...
    Write-Host "Generated page$pageNumber.html"
}
...
for ($i = 5; $i -le 15; $i++) {
    $prevPage = $i - 1
    $nextPage = $i + 1
    Generate-HTML -pageNumber $i -prevPage $prevPage -nextPage $nextPage
