document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatedImageSources = [
        'images/image14/gen1.png',
        'images/image14/gen2.png',
        'images/image14/gen3.png',
        'images/image14/gen4.png',
        'images/image14/gen5.png',
        'images/image14/gen6.png',
        'images/image14/gen7.png'
    ];
    ...
    function loadImages() {
        ...
        generatedImageSources.forEach((generatedImageSrc, index) => {
            const referenceImageSrc = 'images/image14/ref.png';
    ...
    document.querySelectorAll('[data-next-page], [data-prev-page]').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            if (nextPage) {
                ...
                localStorage.setItem('ranking_page_14', JSON.stringify({
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', function() {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (pageRanking) {
                    allRankings[page_\14] = JSON.parse(pageRanking);
                }
            }
    ...
    const savedRanking = localStorage.getItem('ranking_page_14');
    if (savedRanking) {
        ...
        rankingOrder.forEach((index, rank) => {
            const container = document.querySelector(.image-container[data-image-id=""]);
            if (container) {
                container.classList.add('selected');
