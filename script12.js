document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatedImageSources = [
        'images/image12/gen1.png',
        'images/image12/gen2.png',
        'images/image12/gen3.png',
        'images/image12/gen4.png',
        'images/image12/gen5.png',
        'images/image12/gen6.png',
        'images/image12/gen7.png'
    ];
    ...
    function loadImages() {
        ...
        generatedImageSources.forEach((generatedImageSrc, index) => {
            const referenceImageSrc = 'images/image12/ref.png';
    ...
    document.querySelectorAll('[data-next-page], [data-prev-page]').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            if (nextPage) {
                ...
                localStorage.setItem('ranking_page_12', JSON.stringify({
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', function() {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (pageRanking) {
                    allRankings[page_\12] = JSON.parse(pageRanking);
                }
            }
    ...
    const savedRanking = localStorage.getItem('ranking_page_12');
    if (savedRanking) {
