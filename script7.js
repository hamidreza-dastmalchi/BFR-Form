document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatedImageSources = [
        'images/image7/gen1.png',
        'images/image7/gen2.png',
        'images/image7/gen3.png',
        'images/image7/gen4.png',
        'images/image7/gen5.png',
        'images/image7/gen6.png',
        'images/image7/gen7.png'
    ];
    ...
    function loadImages() {
        ...
        generatedImageSources.forEach((generatedImageSrc, index) => {
            const referenceImageSrc = 'images/image7/ref.png';
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', function() {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (pageRanking) {
                    allRankings[page_\7] = JSON.parse(pageRanking);
                }
            }
    ...
    const savedRanking = localStorage.getItem('ranking_page_7');
    if (savedRanking) {
