document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatedImageSources = [
        'images/image10/gen1.png',
        'images/image10/gen2.png',
        'images/image10/gen3.png',
        'images/image10/gen4.png',
        'images/image10/gen5.png',
        'images/image10/gen6.png',
        'images/image10/gen7.png'
    ];
    ...
    document.querySelectorAll('[data-next-page], [data-prev-page]').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            if (nextPage) {
                ...
                localStorage.setItem('ranking_page_10', JSON.stringify({
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', function() {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (pageRanking) {
                    allRankings[page_\10] = JSON.parse(pageRanking);
                }
            }
    ...
    const savedRanking = localStorage.getItem('ranking_page_10');
    if (savedRanking) {
